...
Marble::Marble(int nodeId, int type, Player* owner)
{
    this->myNode = nodeId;
    this->type = type;
    this->owner = owner;
 ...
 */
bool Marble::isDead(){return myNode > DEADLIMIT;}
